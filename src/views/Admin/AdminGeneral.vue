  ...
  <div class="flex items-center flex-col mb-10">
    <div class="w-11/12 pt-10">
      ...
      <div class="flex flex-row gap-2 mt-5">
        <input type="text" placeholder="输入一个新的类别" class="input input-bordered w-full max-w-xs"
      ...
      <div class="flex gap-2 mt-8 flex-wrap">
        <div v-for="(each, index) in cateList" :key="index" class="indicator">
          <div class="indicator-item">
            <!-- 删除按钮 -->
            <button class="btn btn-circle btn-xs" @click="deleteCate(each)">
    ...
    <div class="w-11/12 pt-10">
      ...
      <div class="flex flex-row gap-2 my-5">
        <input type="text" placeholder="想将通知发送到哪个群？" class="input input-bordered w-full max-w-xs"
